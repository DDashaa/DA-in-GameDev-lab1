...
Видео: https://skr.sh/vH19YGCQsRX


- Вывод: В ходе обучения, RollerAgent научился катиться в сторону куба и не падать с платформы, а точнее частота и колличество падений заметно сократились. За время последнего наблюдения я не заметил ни одного случая падения с поатформы, шар всегда следует а кубом. А значит обучение прошло успешно.И чем больше копий объекта, тем быстрее проходит обучение. 
...
В ходе выполнения лабораторной работы я научилась базовым приемам работы с с MlAgents в Unity.

Игровой баланс - это система, делающая игру более комфортной и привлекательной для пользователей. Например, игровой баланс отражаетя на ощущениях от игры: пользоватьелю не должно казаться, что играть становится слишком легко или слишком сложно. Игровой баланс также отражается в накоплении опыта от прохождения разных квестов: нельзя позволить игроку получить много опыта с какого-то одного квеста. Боссы и другие противники тоже дожны быть сильными, но не всемогущими. Таким образом игровой валанс должен учитывать множество аспектов, которые можно выразить математически. Но для этого не существует единой формулы. Поэтому, чтобы облегчить достижение игрового баласа можно прибегать к использованию машинного обучения. Например, в некоторых случаях это позволяет подстраивать игровой баланс под навыки игрока - алгоритмов адаптивного баланса. 
## Powered by
